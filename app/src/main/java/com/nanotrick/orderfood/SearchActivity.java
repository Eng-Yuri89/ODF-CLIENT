...
import com.nanotrick.orderfood.Model.Favorites;
import com.nanotrick.orderfood.Model.Food;
import com.nanotrick.orderfood.Model.Order;
import com.nanotrick.orderfood.ViewHolder.FoodViewHolder;
...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        materialSearchBar.setHint("Please enter food");
                ...
                viewHolder.fav_image.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (!localDB.isFavorites(adapter.getRef(position).getKey(), Common.currentUser.getPhone())) {
                            ...
                            viewHolder.fav_image.setImageResource(R.drawable.ic_favorite_black_24dp);
                            Toast.makeText(SearchActivity.this, "" + model.getName() + "Add to Favorites", Toast.LENGTH_SHORT).show();
                        } else {
                            localDB.removeFromFavorites(adapter.getRef(position).getKey(), Common.currentUser.getPhone());
                            viewHolder.fav_image.setImageResource(R.drawable.ic_favorite_border_black_24dp);
                            Toast.makeText(SearchActivity.this, "" + model.getName() + "Remove from Favorites", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
