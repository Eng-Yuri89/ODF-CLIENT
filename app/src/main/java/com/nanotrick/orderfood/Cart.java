package com.nanotrick.orderfood;
...
import com.nanotrick.orderfood.Database.Database;
import com.nanotrick.orderfood.Helper.RecyclerItemTouchHelper;
...
import com.nanotrick.orderfood.Model.Order;
import com.nanotrick.orderfood.Model.Request;
...
import com.nanotrick.orderfood.ViewHolder.CartAdapter;
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    if (Common.currentUser.getHomeAddress() != null || !TextUtils.isEmpty(Common.currentUser.getHomeAddress())) {
                        ...
                        Toast.makeText(Cart.this, "Please Add your home address", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
...
//                comment = edtComment.getText().toString();
                ...
                if (!rdiShipToAddress.isChecked() && !rdiHomeAddress.isChecked()) {
                    ...
                    if (shippingAddress != null) {
                        ...
                        Toast.makeText(Cart.this, "Please enter or select an address", Toast.LENGTH_SHORT).show();
                ...
                if (!rdiCod.isChecked() && !rdiPaypal.isChecked() && !rdiOrderBalance.isChecked()) {
                    ...
                    Request request = new Request(
                            ...
                            "COD",
                            String.format("%s, %s", mLastLocation.getLatitude(), mLastLocation.getLongitude()), // Coordinates When a user places an order
                            cart);
                    ...
                    // User Balance Complete after receiving the total price of this order
                    if (Double.parseDouble(Common.currentUser.getBalance().toString()) >= amount) {
                        ...
                        Toast.makeText(Cart.this, "Balance is low, please choose another payment method", Toast.LENGTH_SHORT).show();
                    }
...
//                    Sender content = new Sender(serverToken.getToken(), notification);
                ...
                dataSend.put("title", "NanoTrick");
                dataSend.put("message", "The order came in.! " + order_number);
    ...
    private void displayLocation() {
        ...
        if (mLastLocation != null) {
            Log.d("LOCATION", "My location : " + mLastLocation.getLatitude() + ", " + mLastLocation.getLongitude());
