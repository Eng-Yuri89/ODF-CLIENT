...
import com.nanotrick.orderfood.Model.Rating;
    ...
    private void showRatingDialog() {
        if (!FoodDetail.this.isFinishing()) {
            new AppRatingDialog.Builder()
                    .setPositiveButtonText("Enrollment")
                    .setNegativeButtonText("cancel")
                    .setNoteDescriptions(Arrays.asList("I do not like the taste.", "So so", "It's normal.", "it's delicious", "It's delicious."))
                    .setDefaultRating(1)
                    .setTitle("Please rate this food.")
                    .setDescription("Please rate stars and ratings.")
...
//                collapsingToolbarLayout.setTitle(currentFood.getName());
    ...
    public void onPositiveButtonClicked(int value, String comments) {
        ...
        // Load Rating and upload it to firebase
        final Rating rating = new Rating(Common.currentUser.getPhone(),
                foodId,
                String.valueOf(value),
                comments);

        // User can make multiple evaluations
        ratingTbl.push()
                .setValue(rating)
