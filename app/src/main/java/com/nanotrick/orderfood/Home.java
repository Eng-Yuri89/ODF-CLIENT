...
import com.nanotrick.orderfood.Model.Banner;
import com.nanotrick.orderfood.Model.Category;
import com.nanotrick.orderfood.Model.Token;
import com.nanotrick.orderfood.ViewHolder.MenuViewHolder;
...
//            showChangePasswordDialog();
                ...
                FirebaseDatabase.getInstance()
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                Toast.makeText(Home.this, "Set your home address !", Toast.LENGTH_SHORT).show();
                            }
                        });
            }
        });
                        ...
                        user.child(Common.currentUser.getPhone())
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        Toast.makeText(Home.this, "The password has changed.!", Toast.LENGTH_SHORT).show();
    ...
    private void showUpdateNameDialog() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(Home.this);
        alertDialog.setTitle("Reset name");
        alertDialog.setMessage("Please reset your name !");
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                if (task.isSuccessful()) {
                                    Toast.makeText(Home.this, "Name reset done!", Toast.LENGTH_SHORT).show();
                                }
